...
public class MyBD {
    ...
    public Cursor read(String query){
       /* SQLiteDatabase sd = bDhelper.getReadableDatabase();
        Cursor cursor = sd.query("client" ,null, null, null, null, null, null);
        //ii=cursor.getColumnIndex("client");

        */
        try {
            bDhelper.createDataBase();
